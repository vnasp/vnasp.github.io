  ...
  return (
    <div id="contact" className="bg-violet-900 h-auto p-4 pb-20 text-white text-center">
      ...
      <div className="flex py-3 justify-center">
        ...
        <div className="m-3"><a href="http://github.com/vnasp" aria-label="Revisa mi GitHub" target="_blank"><svg width="24px" height="24px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
